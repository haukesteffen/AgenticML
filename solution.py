...
HYPOTHESIS = "hyperparameters: n_estimators=300 with shallow trees"
...
def fit_predict(
    ...
    model = XGBClassifier(enable_categorical=True, tree_method="hist", colsample_bytree=0.8, max_bin=4096, max_depth=4, n_estimators=300)
