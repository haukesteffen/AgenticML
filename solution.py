...
HYPOTHESIS = "hyperparameters: max_bin=2048 for even finer histogram splits"
...
def fit_predict(
    ...
    model = XGBClassifier(enable_categorical=True, tree_method="hist", colsample_bytree=0.8, max_bin=2048)
