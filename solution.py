...
HYPOTHESIS = "ovr LightGBM with calibrated class offsets and a slightly larger final refit uplift after early stopping"
...
def _final_iteration_count(best_iteration: int, calibration_fraction: float) -> int:
    ...
    uplift = 1.0 + min(0.15, calibration_fraction)
